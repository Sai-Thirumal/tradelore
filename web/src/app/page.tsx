    ...
    <main className="landing-page">
      ...
      <header className="landing-header">
        ...
        <div className="landing-header-actions">
          <Link className="landing-link-btn" href="/login?mode=signin">Log in</Link>
          <Link className="landing-primary-btn small" href="/login">Start journaling</Link>
        </div>
      </header>
      ...
      <section className="landing-section landing-trade-detail">
        <div className="trade-detail-copy">
          ...
          <Link className="landing-primary-btn" href="/login">Open your journal</Link>
        </div>
      ...
      <section className="landing-final-cta">
        ...
        <Link className="landing-primary-btn" href="/login">Start with TradeLore</Link>
      </section>
    </main>
  );
}
